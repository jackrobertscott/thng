      ...
      [
        ...
        $('div', {
          className: css({
            ...
            width: FIB[5] + FIB[2],
            height: FIB[5] + FIB[2],
            background: thm.bg.border.normal,
        ...
        $('div', {
          ...
          className: css({
            ...
            border: thm.border.solid,
            color: thm.fc.major.normal,
            background: thm.bg.major.normal,
            boxShadow: thm.shadow.major,
            '& > *:not(:last-child)': {borderBottom: thm.border.solid},
          }),
        }),
      ],
      {reversed: pos === 'above'}
